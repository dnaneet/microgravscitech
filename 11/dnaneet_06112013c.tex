...
%   \begin{figure} 
%    \centering
%     \subfloat{\includegraphics[width=0.45\linewidth]{ic.pdf}\label{fig:1a}} 
%     \subfloat{\includegraphics[width=0.45\linewidth]{grup.pdf}\label{fig:1b}} 
%     \subfloat{\includegraphics[width=0.45\linewidth]{ic_dft.pdf}\label{fig:1c}}
%     \subfloat{\includegraphics[width=0.45\linewidth]{grup_dft.pdf}\label{fig:1d}}
...
%  \begin{figure} 
%    \centering
%     \subfloat{\includegraphics[width=0.45\linewidth]{ic.pdf}\label{fig:2a}} 
%     \subfloat{\includegraphics[width=0.45\linewidth]{zg_rup.pdf}\label{fig:2b}} 
%     \subfloat{\includegraphics[width=0.45\linewidth]{ic_dft.pdf}\label{fig:2c}}
%     \subfloat{\includegraphics[width=0.45\linewidth]{zg_rup_dft.pdf}\label{fig:2d}}
...
%   \begin{figure} 
%    \centering
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_profile_0.pdf}\label{fig:1a}} 
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_profile_Rup.pdf}\label{fig:1b}} \\
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_dft_0_corner.pdf}\label{fig:1c}}
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_dft_corner_Rup.pdf}\label{fig:1d}}
...
%   \begin{figure} 
%    \centering
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_nonwhole_lx_ly_profile_0.pdf}\label{fig:1a}} 
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_nonwhole_lx_ly_profile_Rup.pdf}\label{fig:1b}} \\
%     \subfloat{\includegraphics[width=0.45\linewidth]{/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_nonwhole_lx_ly_dft_0_corner.pdf}\label{fig:1c}}
%     \subfloat{\includegraphics[width=0.45\linewidth] {/home/dnaneet/Research/Dissertation/wigner/ic/random/DCM/dftdata/dcm_2350micrometer_nonwhole_lx_ly_dft_corner_Rup.pdf}\label{fig:1d}}
...
%Different initial conditions used
  \begin{figure} 
   \centering
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig1.pdf}\label{fig:1a}} 
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig9.pdf}\label{fig:1b}} \\
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig3.pdf}\label{fig:1c}}
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig11.pdf}\label{fig:1d}}
   \caption{Two different initial conditions and their discrete Fourier transform frequency distributions. In fig \ref{fig_ic}\subref{fig:1a} a cosine initial condition $1 - 0.05 \left[ \cos [2 \pi x/L] + \sin [2 \pi x/]\right] \cos[2 \pi y/L]$ is used to excite a quiescent film. In fig \ref{fig_ic} \subref{fig:1b} a uniform random perturbation is used to excite the quiescent film.}
   \label{fig_ic}
  \end{figure}
...
%Effect of initial conditions on square domain
  \begin{figure} 
   \centering
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig8.pdf}\label{fig:2a}} 
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig4.pdf}\label{fig:2b}}
%    \subfloat{\includegraphics[width=0.4\linewidth]{Fig7.pdf}\label{fig:2d}}
   \caption{The effect of gravity on film dynamics for a square domain with $L=\lambda_\text{max}$. In fig \ref{fig_ic_effect}\subref{fig:2b}The discrete Fourier transforms show a cascade of frequencies for zero gravity. The dominant mode is that of the fastest growing wavelength.}
   \label{fig_ic_effect}
  \end{figure}
...
%Changing the domain size: Square/non-whole number and Rectangular/non-whole number
  \begin{figure} 
   \centering
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig16.pdf}\label{fig:3a}} 
    \subfloat[]{\includegraphics[width=0.45\linewidth]{Fig24.pdf}\label{fig:3b}} 
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig16.pdf}\label{fig:3c}}
%    \subfloat{\includegraphics[width=0.4\linewidth]{Fig20.pdf}\label{fig:3d}}
   \caption{The effect of domain size is shown with the cosine initial condition. A square domain is used with $L=2.238\lambda_\text{max}$ in fig \ref{fig_domain_size_effect} \subref{fig:3a} and a rectangular domain is used with $L_x = 2.238 \lambda_\text{max}, L_y=1.641 \lambda_\text{max}$ in figure \ref{fig_domain_size_effect} \subref{fig:3b}. The discrete Fourier transforms show a cascade of frequencies. The dominant mode is that of the fastest growing wavelength.}
...
%   \centering
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig1.pdf}\label{fig:1a}} 
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig2.pdf}\label{fig:1b}} \\
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig3.pdf}\label{fig:1c}}
%    \subfloat{\includegraphics[width=0.4\linewidth]{Fig4.pdf}\label{fig:1d}}
%   \caption{2.35 millimeter DCM film evaporating in Earth's gravitational field. Film is depleted in 1 minute.}
%   \label{fig_eg}
%  \end{figure}
...
%  \begin{figure}
%   \centering
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig5.pdf}\label{fig:2a}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig6.pdf}\label{fig:2b}} \\
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig7.pdf}\label{fig:2c}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig8.pdf}\label{fig:2d}}
...
%  \begin{figure}
%   \centering
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig9.pdf}\label{fig:3aw}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig10.pdf}\label{fig:3bw}} \\
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig11.pdf}\label{fig:3cw}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig12.pdf}\label{fig:3dw}}
...
%  \begin{figure} 
%   \centering
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig13.pdf}\label{fig:3a}} 
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig14.pdf}\label{fig:3b}} \\
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig15.pdf}\label{fig:3c}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig16.pdf}\label{fig:3d}}
...
%  \begin{figure}
%   \centering
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig17.pdf}\label{fig:3ar}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig18.pdf}\label{fig:3br}} \\
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig19.pdf}\label{fig:3cr}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig20.pdf}\label{fig:3dr}}
%   \caption{2.35 millimeter DCM film evaporating in zero gravity, subject to a uniform random initial condition. The domain size is square with it's side-length equal to $L = 2.238 \lambda_\text{max}$. Film ruptures in about 4 seconds. The fastest growing wavelength appears as dominant mode at rupture.}
...
%  \begin{figure} 
%   \centering
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig21.pdf}\label{fig:4a}} 
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig22.pdf}\label{fig:4b}} \\
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig23.pdf}\label{fig:4c}}
%    \subfloat{\includegraphics[width=0.45\linewidth]{Fig24.pdf}\label{fig:4d}}
